    ...
    return (
        <div {...allButtonSection} className='game_menu'>
            ...
            <div {...gameButtonSection} className='sn-section-root game_button' style={offGameButton ? {pointerEvents: 'none'} : {}}>
                <button className='sn-section-item btn_answ' style={{background: btn[0].background, color: btn[0].color}} id='btn_answ1' onClick={() => assistant_global("1", "checkAnsw")}>
                    {isLengthZero() 
                    ? <div></div>
                    : arrayQuestions[currentQuestions].Answer[0]
                    }
                </button>
                <button className='sn-section-item btn_answ' style={{background: btn[1].background, color: btn[1].color}} id='btn_answ2' onClick={() => assistant_global("2", "checkAnsw")}>
                    {isLengthZero() 
                    ? <div></div>
                    : arrayQuestions[currentQuestions].Answer[1]
                    }
                </button>
                <button className='sn-section-item btn_answ' style={{background: btn[2].background, color: btn[2].color}} id='btn_answ3' onClick={() => assistant_global("3", "checkAnsw")}>
                    {isLengthZero() 
                    ? <div></div>
                    : arrayQuestions[currentQuestions].Answer[2]
                    }
                </button>
                <button className='sn-section-item btn_answ' style={{background: btn[3].background, color: btn[3].color}} id='btn_answ4' onClick={() => assistant_global("4", "checkAnsw")}>
                    {isLengthZero() 
                    ? <div></div>
